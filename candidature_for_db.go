...
type Contact struct {
	...
	Value         string `datastore:"value,omitempty" bson:"value,omitempty"`                   // Endereço da rede social, podendo ser o link para o Instagram, Twitter, um site, ou o telefone do candidato.
}
