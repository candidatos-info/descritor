...
func TestCandidatura(t *testing.T) {
	...
	cand := Candidatura{
		...
		Candidato: &Candidato{
			...
			Raca:            "PARDA",
			Ocupacao:        "ENGENHEIRO",
			PictureURL:      "http://host.com/picture",
		},
	}
	j, err := cand.ToJSON()
	if err != nil {
